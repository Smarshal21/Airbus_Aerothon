package com.example.aerothon.fragments
...
import com.example.aerothon.interfaces.MyBlockchainApi
import com.example.aerothon.interfaces.MyMLApi
import com.example.aerothon.models.FileinModel
import com.example.aerothon.models.FlightDataModel
...
class PilotFlightDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_Pilot_Flight_details, container, false)
        val etFlightNumber: EditText = view.findViewById(R.id.etFlightNumber)
        val etDepartureAirport: EditText = view.findViewById(R.id.etDepartureAirport)
        val etArrivalAirport: EditText = view.findViewById(R.id.etArrivalAirport)
        val etDepartureTime: EditText = view.findViewById(R.id.etDepartureTime)
        val etArrivalTime: EditText = view.findViewById(R.id.etArrivalTime)
        val etAircraftType: EditText = view.findViewById(R.id.etAircraftType)
        val etAircraftID: EditText = view.findViewById(R.id.etAircraftID)
        val etCurrentWeatherDeparture: EditText = view.findViewById(R.id.etCurrentWeatherDeparture)
        val etCurrentWeatherArrival: EditText = view.findViewById(R.id.etCurrentWeatherArrival)
        val etWindSpeedDeparture: EditText = view.findViewById(R.id.etWindSpeedDeparture)
        val etWindSpeedArrival: EditText = view.findViewById(R.id.etWindSpeedArrival)
        val etWeatherAdvisories: EditText = view.findViewById(R.id.etWeatherAdvisories)
        val etFuelStatus: EditText = view.findViewById(R.id.etFuelStatus)
        val etCrewStatus: EditText = view.findViewById(R.id.etCrewStatus)
        val etPreFlightChecks: EditText = view.findViewById(R.id.etPreFlightChecks)
        val etMechanicalIssues: EditText = view.findViewById(R.id.etMechanicalIssues)
        val etPassengerCount: EditText = view.findViewById(R.id.etPassengerCount)
        val etPassengerStatus: EditText = view.findViewById(R.id.etPassengerStatus)
        val etLuggageStatus: EditText = view.findViewById(R.id.etLuggageStatus)
        val etAdditionalInfo: EditText = view.findViewById(R.id.etAdditionalInfo)
...
//        }
    ...
    private fun initializeData(){
        FlightType = arguments?.getString("FlightType")!!
    ...
    private fun saveFlightDetailsInDatabase(mlOutput:String){
        dialogBox("Saving Data in Database","Please wait")
        val sharedPreferences = requireContext().getSharedPreferences("MyPrefs", Context.MODE_PRIVATE)
        val scoreReceived = sharedPreferences.getString("testScore","")!!
        var FlightData = FlightDataModel(userName, uid, email, FlightType, et1.text.toString(), et2.text.toString(), scoreReceived, et3.text.toString(), et4.text.toString(), et5.text.toString(), et6.text.toString(), et7.text.toString(), et8.text.toString(), et9.text.toString(), et10.text.toString(), mlOutput)
        database.reference.child("Flights")
            .child(uid)
            .setValue(FlightData)
...
//                        resultTextView.text = "Prediction: ${myResponse.prediction}"
                        ...
                        if(statusFromML == "1"){
                            mlOutput = "Accepted"
                            saveFlightDetailsInDatabase(mlOutput)
                            postData(mlOutput)
                        }
