...
import com.example.aerothon.databinding.ActivityStatusScreenBinding
...
class StatusScreenActivity : AppCompatActivity() {
    ...
    private fun getStatusFromDatabase(){
        dialogBox("Fetching your Flight status","Please wait...")
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    for(snapshot1 in snapshot.children){
                        ...
                        if(data!!.uid == uid){
                            ...
                            binding.tvFlightType.text = data!!.FlightType
                            if(status == "Accepted"){
