...
import com.example.aerothon.adapters.PdfAdapter
import com.example.aerothon.databinding.ActivityDocsDetailsBinding
            ...
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for(snapshot1 in snapshot.children){
                        val data = snapshot1.getValue(FlightDataModel::class.java)
                        if(data!!.uid == uid){
                            binding.tv10.text = data.name
                            binding.tv11.text = data.uid
                            binding.tv12.text = data.FlightType
